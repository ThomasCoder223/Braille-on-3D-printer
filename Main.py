...
def Translate(Row):
  ...
  for item in Row:
    if item == '1':
      ...
      gCode = gCode + 'G0 X2;\n'
      endXofset = endXofset + 2
    elif item == '4':
      gCode = gCode + 'G0 X4;\n'
      endXofset = endXofset + 4
    elif item == '0':
      gCode = gCode + ''
    else:
      gCode = gCode + ';error\n'
...
def Append():
  if len(nxt) == 6:
     ...
     firstRow.append(nxt[9])
     firstRow.append('4')
     firstRow.append(nxt[12])
     firstRow.append('2')
     firstRow.append(nxt[15])
     firstRow.append('4')
     ...
     secondRow.append(nxt[10])
     secondRow.append('4')
     secondRow.append(nxt[13])
     secondRow.append('2')
     secondRow.append(nxt[16])
     secondRow.append('4')
     ...
     thirdRow.append(nxt[11])
     thirdRow.append('4')
     thirdRow.append(nxt[14])
     thirdRow.append('2')
     thirdRow.append(nxt[17])
     thirdRow.append('4')
...
for letter in text:
  listOfCharacters.append(letter)
...
for i in range(len(listOfCharacters)):
  ...
  match listOfCharacters[i]:
    ...
    case "0":
      nxt = '010110'
    case _:
      print('i dont know that one yet')
...
text_file = open(r'Export.gcode', 'w')
